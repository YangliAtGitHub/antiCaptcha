...
namespace CaptchaRecogizeDemo
{
    public class ImageProcess
    {
        ...
        public static string GetYZMCode(Image img, string zimoPath, int maxNearPoints, int smallPicWidth,
            int smallPicHeight, int type = 2, bool is4Chars = true, int charWidth = 10)
        {
            //1.0验证码前期处理
